...
class PlatformsControllerTest < ActionController::TestCase
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post :create, platform: { description: @platform.description, image: @platform.image, name: @platform.name }
    end
  ...
  test "should update platform" do
    put :update, id: @platform, platform: { description: @platform.description, image: @platform.image, name: @platform.name }
    assert_redirected_to platform_path(assigns(:platform))
  end
